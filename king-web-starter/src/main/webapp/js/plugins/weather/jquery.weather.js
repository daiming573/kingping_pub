    ...
    Weather.prototype = {
        ...
        moveIcon: function () {
            ...
            function creatMove($this, i) {
                var current_function = arguments.callee, widthMax = $this.parent().width(), start = 0, end = 0,
                    width = $this.width() || 160, leftMax = widthMax - width, duration = _self.opts.duration,
                    left = rand(0, leftMax), fps = _self.opts.fps,
        ...
        drop: function ($wearherChild) {
            ...
            $wearherChild.find('div[name=init]').each(function () {
                var $this = $(this), top = parseInt($this.css('top')) || 0,
        ...
        makeDrop: function ($wearherChild) {
            var objWidth = $wearherChild.width(), objHeight = $wearherChild.height(), left = 0, end = 0,
                index = rand(0, (this.skyState.drop.length || 1) - 1), flyTime = this.skyState.drop[index].time || 300,
                is = '', i = 0, i_len = rand(2, 6);
